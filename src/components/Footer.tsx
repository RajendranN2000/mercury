...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#F3F4F6] rounded-t-3xl px-32 pb-20 py-32">
      <div className=" mx-auto space-y-10">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-10">
          ...
          <div className="flex space-x-6 text-[#2B2B31] text-2xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm text-[#6D7079]">
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                Secured Data{" "}
                <span className="text-xs bg-white text-[#0E0E11] px-2 py-1 rounded-md shadow">
                  New
                </span>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                Careers{" "}
                <span className="text-xs bg-white text-[#878A92] px-2 py-0.5 rounded-md shadow">
                  New
                </span>
              </li>
              <li>Team</li>
