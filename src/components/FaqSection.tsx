    ...
    <div className=" flex flex-col items-center justify-center py-16 px-6 text-white">
      ...
      <div className="mt-10 w-full max-w-2xl space-y-4">
        {faqData.map((faq, index) => (
          <div
            key={index}
            className="bg-white border border-[#E8EAED] rounded-lg text-black overflow-hidden"
          >
            <button
      ...
      <div className="mt-16 text-center">
        <h3 className="text-[#0E0E11] font-bold text-[30px] mb-2">Need Help?</h3>
        <p className="text-[#3B3C45] max-w-[550px] text-sm mx-auto mb-6">
        ...
        <button className="bg-[#0E0E11] text-white text-sm font-semibold py-3 px-6 rounded-full">
          Book a Demo
        </button>
      </div>
    </div>
